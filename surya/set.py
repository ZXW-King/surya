...
class Settings(BaseSettings):
    ...
    DETECTOR_MODEL_CHECKPOINT: str = "/gemini/code/vikp/surya_det3"
    ...
    # Text recognition
    RECOGNITION_MODEL_CHECKPOINT: str = "/gemini/code/vikp/surya_rec2"
    ...
    # Layout
    LAYOUT_MODEL_CHECKPOINT: str = "/gemini/code/vikp/datalab-to/surya_layout"
    ...
    # Table Rec
    TABLE_REC_MODEL_CHECKPOINT: str = "/gemini/code/vikp/surya_tablerec"
    ...
    # OCR Error Detection
    OCR_ERROR_MODEL_CHECKPOINT: str = "/gemini/code/vikp/datalab-to/ocr_error_detection"
